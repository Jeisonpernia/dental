...
class PatientFeedbackPopup(models.TransientModel):
    ...
    q1 = fields.Selection([('YES', 'YES'), ('NO', 'NO'), ('not_apply', 'Does Not Apply'), ],
                          '1. Did your dental provider clearly explain to you the condition of your teeth & gums?')
    ...
    q9 = fields.Selection([('YES', 'YES'), ('NO', 'NO'), ('not_apply', 'Does Not Apply'), ],
                          '9. Are you satisfied with the dental treatment that you received from your provider?')
    q10 = fields.Selection([('YES', 'YES'), ('NO', 'NO'), ('not_apply', 'Does Not Apply'), ],
                           '10. Would you recommend your dental care provider to your friends and family members?')
    ...
    q12 = fields.Selection([('YES', 'YES'), ('NO', 'NO'), ('not_apply', 'Does Not Apply'), ],
                           '12. Were you provided with information about the Dental Care Center policies?')
    ...
    q15 = fields.Selection([('YES', 'YES'), ('NO', 'NO'), ('not_apply', 'Does Not Apply'), ],
                           '15. Did you find the Dental Care Center to be well maintained?')
    q16 = fields.Selection([('YES', 'YES'), ('NO', 'NO'), ('not_apply', 'Does Not Apply'), ],
                           '16. Would you recommend the Dental Care Center to someone else?')
