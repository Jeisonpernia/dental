odoo.define('calendar_resource_view.colorpicker', function(require) {
    "use strict";
    ...
    var FieldColorPicker = Field.extend({
        ...
        cssLibs: [
            '/calendar_resource_view/static/src/lib/bootstrap-colorpicker/css/bootstrap-colorpicker.css'
        ],
        jsLibs: [
            '/calendar_resource_view/static/src/lib/bootstrap-colorpicker/js/bootstrap-colorpicker.js'
        ],
