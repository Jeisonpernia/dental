...
var fc = $.fullCalendar2 = { version: "2.4.0" };
...
$.fn.fullCalendar2 = function(options) {
	...
	this.each(function(i, _element) { // loop each DOM element involved
		...
		var calendar = element.data('fullCalendar2'); // get the existing calendar object (if any)
		...
		if (typeof options === 'string') {
			if (calendar && $.isFunction(calendar[options])) {
				...
				if (options === 'destroy') { // for the destroy method, must remove Calendar object data
					element.removeData('fullCalendar2');
				}
			}
		}
		// a new calendar initialization
			...
			element.data('fullCalendar2', calendar);
			calendar.render();
		}
	});
...
var View = fc.View = Class.extend({
	...
	triggerDayClick: function(cell, dayEl, ev) {
		this.trigger('dayClick', dayEl, cell, ev);
	},
...
var Calendar = fc.Calendar = Class.extend({
	...
	overrides: null, // option overrides given to the fullCalendar2 constructor
